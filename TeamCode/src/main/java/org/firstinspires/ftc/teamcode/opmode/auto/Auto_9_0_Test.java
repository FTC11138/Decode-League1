...
@Autonomous(name = "Auto_6_0_Loser :(")
@Configurable
public class Auto_9_0_Test extends LinearOpMode {
    ...
    public static double shoot1Heading = 180 - 144;


    public static double intake2X = 144 - 25;
    ...
    public static double intake3X = 144 - 28;
    ...
    public static double controlshoot2Y = 144 - 58;
