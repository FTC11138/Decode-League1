...
@Autonomous(name = "Auto_6_0_Red_Gate amAZING")
@Configurable
public class Auto_Gate_Open_Red extends LinearOpMode {
    ...
    public static double intake1X = 144 - 23;
    ...
    public static double gate14X = 144 - 33;
    public static double gate14Y =  72;
    public static double gate14Heading = 180 - 270;

    public static double gate24X = 144 - 22;
    public static double gate24Y = 72;
    public static double gate24Heading = 180 - 270;
//
...
//    public static double shoot4Heading = 145;
    ...
    public static double control4X = 144 - 76;
