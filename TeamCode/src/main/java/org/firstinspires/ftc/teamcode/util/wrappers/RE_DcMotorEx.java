...
public class RE_DcMotorEx {
    ...
    private int targetPosition = 0, lastTarget = 0;
    ...
    public int getPosition(){return  this.currentPosition;}
    public int getTarget(){return this.targetPosition;}
    public void setPower(double power){this.power = power;}

    public void setTargetPosition(int target, double power){
        this.lastTarget = this.targetPosition;
    ...
    public void setMode(DcMotor.RunMode mode){this.motor.setMode(mode);}
